...
type AdminPresenter interface {
	// AdminMenu returns choice 1-6 (users/groups/services/system params/
	// trusted networks/audit log) or back (PF3, to the service menu). It loops
	// internally on invalid input.
